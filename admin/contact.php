...
<section class="relative min-h-screen w-full">
  ...
  <img src="https://pagedone.io/asset/uploads/1696488602.png" alt="ContactUs tailwind section" 
       class="absolute inset-0 w-full h-full object-cover bg-blend-multiply bg-indigo-700" />
  
  <!-- กล่องเนื้อหา -->
  <div class="relative z-10 flex flex-col justify-center min-h-screen px-8 md:px-16 lg:px-32">
    
    <!-- หัวข้อ -->
    <h1 class="font-manrope text-white text-5xl md:text-6xl font-bold leading-tight mb-8 max-w-4xl">
      Contact us
    </h1>
    
    <!-- กล่องสีขาวใส่ข้อมูล ติดต่อ -->
    <div class="bg-white bg-opacity-90 rounded-lg p-8 max-w-lg md:max-w-xl lg:max-w-2xl shadow-lg">
      
      <a href="javascript:;" class="flex items-center mb-8">
        <!-- Phone icon -->
        ...
        <h5 class="text-black text-lg md:text-xl font-normal leading-7 ml-6">092-8034-116</h5>
      </a>
      ...
      <a href="javascript:;" class="flex items-center mb-8">
        ...
        <h5 class="text-black text-lg md:text-xl font-normal leading-7 ml-6">admin@admin.com</h5>
      </a>
      ...
      <a href="javascript:;" class="flex items-center">
        ...
        <h5 class="text-black text-lg md:text-xl font-normal leading-7 ml-6">31/38 Khlong Song, Khlong Luang District, Pathum Thani 12120</h5>
      </a> 
    </div>
  </div>
</section>
